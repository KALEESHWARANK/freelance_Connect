    ...
    <div class="hero-content">
      ...
      <div class="actions">
        <?php if ($role === 'client'): ?>
          ...
          <a href="../frontend/view_applications.php">📥 Applications Received</a>
        <?php else: ?>
          <a href="../frontend/browse_jobs.php">🔍 Find Freelance Jobs</a>
          <a href="../frontend/my_applications.php">📂 Track My Applications</a>
        <?php endif; ?>
      </div>
    </div>
